...
#define kIID_Switch		               ((uint64_t) 0x0034)
#define kIID_SwitchServiceSignature 	((uint64_t) 0x0035)
#define kIID_SwitchName             	((uint64_t) 0x0036)
#define kIID_SwitchOn               	((uint64_t) 0x0037)

HAP_STATIC_ASSERT(kAttributeCount == 9 + 3 + 5 + 4 + 4, AttributeCount_mismatch);
...
const HAPService switchService_2 = {
    .iid = kIID_Switch,
    .serviceType = &kHAPServiceType_Switch,
    .debugDescription = kHAPServiceDebugDescription_Switch,
    .name = "Switch2",
