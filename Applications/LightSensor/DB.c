...
#define kIID_LightSensorBulb                ((uint64_t) 0x0030)
#define kIID_LightSensorServiceSignature 	((uint64_t) 0x0031)
#define kIID_LightSensorName             	((uint64_t) 0x0032)
#define kIID_LightLevel               		((uint64_t) 0x0033)
 ...
 */
const HAPFloatCharacteristic lightLevelCharacteristic = {
    ...
    .constraints = { .minimumValue 	= 0.1,
				     .maximumValue 	= 100000,
				     .stepValue 	= 0.1  },
    .callbacks = { .handleRead = HandleLightLevelRead, .handleWrite = NULL }
};
