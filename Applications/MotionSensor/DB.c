...
#define kIID_MotionSensor                 ((uint64_t) 0x0030)
#define kIID_motionSensorServiceSignature ((uint64_t) 0x0031)
#define kIID_MotionSensorName             ((uint64_t) 0x0032)
#define kIID_MotionDetected               ((uint64_t) 0x0033)
 ...
 */
static const HAPDataCharacteristic motionSensorServiceSignatureCharacteristic = {
    .format = kHAPCharacteristicFormat_Data,
    .iid = kIID_motionSensorServiceSignature,
    .characteristicType = &kHAPCharacteristicType_ServiceSignature,
    .debugDescription = kHAPCharacteristicDebugDescription_ServiceSignature,
    .manufacturerDescription = NULL,
    .properties = { .readable = true,
 ...
 */
static const HAPStringCharacteristic motionSensorNameCharacteristic = {
    .format = kHAPCharacteristicFormat_String,
    .iid = kIID_MotionSensorName,
    .characteristicType = &kHAPCharacteristicType_Name,
    .debugDescription = kHAPCharacteristicDebugDescription_Name,
    .manufacturerDescription = NULL,
    .properties = { .readable = true,
...
/**
 * The 'MotionDetected' characteristic of the Light Bulb service.
 */
 ...
 */
const HAPService motionSensorService = {
    ...
    .linkedServices = NULL,
    .characteristics = (const HAPCharacteristic* const[]) { &motionSensorServiceSignatureCharacteristic,
                                                            &motionSensorNameCharacteristic,
